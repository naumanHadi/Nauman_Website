...
- AI & Product: I think of the full AI stack as four layers that build the product — (1) Infrastructure, the physical & data layer (compute, storage, telemetry ingestion); (2) Agents & Models, where the intelligence lives (agents for sensing, perception, forecasting, and recommendation, powered by LLM/RAG plus classical ML like Random Forest, Gradient Boosting, XGBoost, AdaBoost, Isolation Forest, K-Means, and DNNs, with dataset cleaning and feature engineering); (3) Applications that subscribe to the agents and turn them into workflows; and (4) a Visualization layer that surfaces all the telemetry. Commercialization is what I do around the product — turning the stack into enterprise revenue (discovery, technical sales, SOWs, production rollout; ~$13M in POs). Zero-to-one builder.
...
- Float Fleet Inc. (Entrepreneurship): a logistics company I founded during COVID with a vision for autonomous trucking technology, then pivoted into hands-on freight operations — freight procurement, sales, and dedicated reefer and dry van service. Scaled the fleet to five trucks and sold the operations in a successful exit; hands-on operations, logistics, finance, and negotiation.
